...
export interface Country {
  ...
  dial?: string;
  DS?: string;
  FIPS?: string; // Federal Information Processing Standard (FIPS) 10-4
  EDGAR?: string; // https://www.sec.gov/edgar/searchedgar/edgarstatecodes.htm
...
const countryDatabase: Country[] = [
  {
    ...
    MARC: 'ch',
    tld: '.tw',
    officialName: 'Republic of China (ROC)'
  },
  {
    name: 'Afghanistan',
    capital: 'Kabul',
